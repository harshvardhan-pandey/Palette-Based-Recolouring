...
python3 palette_extraction/extractor.py --img "$alb_path" --out "$out_path"

# # palette refinement
obj_ori_path="${out_path}original_palette.obj"
python3 palette_extraction/refiner.py --img "$alb_path" --obj "$obj_ori_path" --out "$out_path"
